...
public class JoinGraph extends BaseQueryObject implements IJoinGraph {
    ...
    private Graph<IExpressionId, IAssociation> graph = new PersistentGraph<IExpressionId, IAssociation>();
    ...
    /**
     * @param parentExpressionId The parent Expression id to be added in
     *            joingraph.
     * @param childExpressionId The child Expression id to be added in
     *            joingraph.
    ...
    private Graph<IExpressionId, IAssociation> getGraph() {
        return graph;
    }

    @SuppressWarnings("unused")
    private void setGraph(Graph<IExpressionId, IAssociation> graph) {
        this.graph = graph;
    }
}