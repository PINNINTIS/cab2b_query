...
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER number(19,0) not null, QUERY_NAME varchar2(255 char) unique, DESCRIPTION varchar2(1024 char), CREATED_DATE timestamp not null, primary key (IDENTIFIER));
